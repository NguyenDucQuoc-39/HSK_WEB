    ...
    <div class="max-w-5xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="md:flex md:items-center md:justify-between pb-6 border-b border-slate-200">
            ...
            <div class="mt-4 flex md:mt-0 md:ml-4">
                {{-- SỬA ĐỔI TẠI ĐÂY: Chuyển button thành thẻ a --}}
                <a href="{{ route('vocabulary.flashcard', $selectedLevel->id) }}" class="w-full inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 transition transform hover:scale-105">
                    <svg class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 8.25V6a2.25 2.25 0 00-2.25-2.25H6A2.25 2.25 0 003.75 6v8.25A2.25 2.25 0 006 16.5h2.25m8.25-8.25H18a2.25 2.25 0 012.25 2.25v8.25A2.25 2.25 0 0118 20.25h-7.5A2.25 2.25 0 018.25 18v-1.5m8.25-8.25h-6a2.25 2.25 0 00-2.25 2.25v6" />
                    </svg>
                    Ôn tập (Flashcard)
                </a>
            </div>
                        ...
                        <div class="ml-4 flex-shrink-0 flex items-center space-x-2">
                            ...
                            <button title="Sửa từ"
                                ...
                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.93zM16.862 4.487L19.5 7.125m-1.5-1.5l-2.086-2.086" />
                                </svg>
                            </button>
